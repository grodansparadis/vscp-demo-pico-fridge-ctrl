 ...
 *
 * https://forum.hobbycomponents.com/viewtopic.php?t=1125
 */
...
#warning i2c/lcd_1602_i2c example requires a board with I2C pins
  ...
  static char *message[] = { "RP2040 by",  "Raspberry Pi",  "A brand new",  "microcontroller", "Twin core M0",
                             "Full C SDK", "More power in", "your product", "More beans",      "than Heinz!" };
